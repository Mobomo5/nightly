...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `profilePictureLocation` VARCHAR(60) NOT NULL DEFAULT 'includes/images/defaultUserPicture.png' COMMENT 'The web-accessible location of the users profile picture.',
